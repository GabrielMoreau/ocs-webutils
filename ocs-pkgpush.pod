...
=head1 [--help|-h] --url URL [--username USERNAME] [--password PASSWORD] --name NAME --description DESCRIPTION --priority PRIORITY --notif-text NOTIF_TEXT --notif-delay NOTIF_DELAY --file FILE [--headless]
...
=item B<--notif-delay> I<SECONDS>

Delay before the notification is shown. (Required)
...
Push a package with a given priority and notification:
  ...
  ocs-pkgpush --url https://ocs.example.com/ocsreports \
    ...
    --notif-delay 60 --file ./install.zip
